...
pedal = new Pizzicato.Sound({source:'input'})
...
if (navigator.getUserMedia) {
  ...
  var onSuccess = function(stream) {
    ...
    // //this allows me to hear what im saying through headphones
    ...
    effect.onclick = function () {
      ...
      pedal.addEffect(dubDelay);
      pedal.play();

   effect.ondblclick = function () {
      console.log ("delay off")
      effect.style.background = "";
      pedal.removeEffect(dubDelay);
      pedal.stop();
    }
 }
